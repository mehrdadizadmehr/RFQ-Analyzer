...
export function enrichCustomerRequestStatsWithPurchases(
  ...
  return {
    ...
    effectiveBackground,
    hasRealPurchase,
    manualPurchaseCount: parseNumber(purchaseStats?.manualPurchaseCount),
    manualPurchaseAmount: parseNumber(purchaseStats?.manualPurchaseAmount),
    filePurchaseCount: parseNumber(purchaseStats?.filePurchaseCount),
    filePurchaseAmount: parseNumber(purchaseStats?.filePurchaseAmount),
    totalPurchaseCount,
    totalPurchaseAmount,
